...
## picture Puzzle by rahulraina711
Go to the rahulraina711 directory
 - html css and js code are very simple , nothing complex.
 - the phots are pre cropped and rearranged in the grid.
 - Local Storage has been used to record player names and their number of moves.
 - A "Recent Plays" board shows the recent players that solved the puzzle.
 - A "Champion" board displays the name of the player with the least moves.
 - Buttons like "Hints", "easy win" have been added to manipulate DOM.
 - Mouse cursor changes when hovered over different labels.
